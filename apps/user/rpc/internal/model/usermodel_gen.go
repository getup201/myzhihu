...
var (
	...
	cacheMyzhihuUserUserIdPrefix     = "cache:myzhihuUser:user:id:"
	cacheMyzhihuUserUserMobilePrefix = "cache:myzhihuUser:user:mobile:"
)
...
func (m *defaultUserModel) Delete(ctx context.Context, id int64) error {
	...
	myzhihuUserUserIdKey := fmt.Sprintf("%s%v", cacheMyzhihuUserUserIdPrefix, id)
...
func (m *defaultUserModel) FindOne(ctx context.Context, id int64) (*User, error) {
	myzhihuUserUserIdKey := fmt.Sprintf("%s%v", cacheMyzhihuUserUserIdPrefix, id)
	var resp User
	err := m.QueryRowCtx(ctx, &resp, myzhihuUserUserIdKey, func(ctx context.Context, conn sqlx.SqlConn, v any) error {
...
func (m *defaultUserModel) FindOneByMobile(ctx context.Context, mobile string) (*User, error) {
	...
	var resp User
	err := m.QueryRowIndexCtx(ctx, &resp, myzhihuUserUserMobileKey, m.formatPrimary, func(ctx context.Context, conn sqlx.SqlConn, v any) (i any, e error) {
...
func (m *defaultUserModel) formatPrimary(primary any) string {
	return fmt.Sprintf("%s%v", cacheMyzhihuUserUserIdPrefix, primary)
}
