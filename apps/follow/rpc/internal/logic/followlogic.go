...
import (
	...
	"myzhihu/apps/follow/code"
	"myzhihu/apps/follow/rpc/internal/model"
	"myzhihu/apps/follow/rpc/internal/svc"
	"myzhihu/apps/follow/rpc/internal/types"
	"myzhihu/apps/follow/rpc/pb"
...
func (l *FollowLogic) Follow(in *pb.FollowRequest) (*pb.FollowResponse, error) {
	...
	//缓存操作 只有key存在时才往缓存里加 （followExist）
