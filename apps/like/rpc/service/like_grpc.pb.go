...
const (
	...
	Like_CancelThumbup_FullMethodName = "/service.Like/CancelThumbup"
)
...
func (c *likeClient) CancelThumbup(ctx context.Context, in *CancelThumbupRequest, opts ...grpc.CallOption) (*CancelThumbupResponse, error) {
	out := new(CancelThumbupResponse)
	err := c.cc.Invoke(ctx, Like_CancelThumbup_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLikeServer) CancelThumbup(context.Context, *CancelThumbupRequest) (*CancelThumbupResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CancelThumbup not implemented")
}
...
func _Like_CancelThumbup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelThumbupRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LikeServer).CancelThumbup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Like_CancelThumbup_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LikeServer).CancelThumbup(ctx, req.(*CancelThumbupRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Like_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Like_CancelThumbup_Handler,
		},
	},
